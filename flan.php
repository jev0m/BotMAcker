...
- اهلا بك عزيزي في بوت شنو رأيك بفلان
- البوت للتسليه والضحك فقط، 
- ارسل ( شنو رأيك ب+ الاسم )
- مثال => شنو رأيك بحمود
",

]);
}
if(strpos($text,"شنو رأيك ب")!==false){
$a = str_replace("شنو رأيك ب","",$text);
$b = array("دودكي","يكبسل","مؤدب","حيوان","طيرر","ينيج", "مادري" );
$c = array_rand($b,1);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"والله اني اكول $a $b[$c] 
بقت يمك تصدك متصدك",
]);
}
