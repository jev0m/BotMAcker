...
if ($inline) {
    ...
    bot('answerInlineQuery',[
            ...
            'results' => json_encode([[
                ...
                'title'=>"هذه همسه خاصه ل@$user",
             'input_message_content'=>['parse_mode'=>'HTML','message_text'=>"هذه همسه خاصه ل@$user"],
            'reply_markup'=>['inline_keyboard'=>[
                [
                ['text'=>'عرض الهمسه','callback_data'=>$user."or".$username."or".$wh]
                ],
             ]]
          ]])
        ]);
...
@bot @user messgae
- @bot تعني معرف البوت
- @user تعني معرف المستخدم
- message تعني الرساله
",
		'reply_markup'=>json_encode([
			'inline_keyboard'=>[
			[['text' => "اهمس لصديقك الآن", 'switch_inline_query' => "اكتب معرف صديقك ثم الرساله"]]
			]
		])
]);
}